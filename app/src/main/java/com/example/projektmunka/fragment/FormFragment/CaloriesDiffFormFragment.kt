...
import com.example.projektmunka.viewModel.routeGeneratorViewmodel.CaloriesDiffRouteViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class CaloriesDiffFormFragment : Fragment() {

    private lateinit var binding: FragmentForm4Binding
    private val caloriesDiffRouteViewModel: CaloriesDiffRouteViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnCreateRoute.setOnClickListener {
            ...
            val calories = binding.editTextCalories.text.toString().toDoubleOrNull() ?: 0.0
            ...
            if (selectedRadioButton != null) {
                ...
                if (selectedOptionText == "Choose Address") {
                    lifecycleScope.launch {
                         caloriesDiffRouteViewModel.startSession(RouteGeneratorType.DIFFGENERATOR, address, targetAddress, calories)
                    }
                } else {
                    lifecycleScope.launch {
                          caloriesDiffRouteViewModel.startSession(RouteGeneratorType.DIFFGENERATOR, "", targetAddress, calories)
                    }
                }
            }
